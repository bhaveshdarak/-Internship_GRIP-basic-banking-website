    ...
    <div style={{ marginBottom: '1em', marginTop: '0.1em' }}>
      ...
      <Carousel variant="dark">
        <Carousel.Item>
          ...
          src='https://images.unsplash.com/photo-1616803140344-6682afb13cda?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80'
            alt="First slide"
            style={styles.image1}
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            className="d-block w-100"
            src="https://images.unsplash.com/photo-1501167786227-4cba60f6d58f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2940&q=80"
            alt="Second slide"
            style={styles.image1}
          />
          <Carousel.Caption>
